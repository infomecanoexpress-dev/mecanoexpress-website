...
export const metadata = {
  title: 'Mecano Express | Changement de Pneus à Domicile Montréal',
  description: 'Service mobile de changement de pneus à domicile à Montréal, Laval, Rive-Nord et Rive-Sud. Pneus hiver, été, équilibrage, rotation. Appelez 514 649-7372',
  keywords: 'changement pneus domicile Montréal, mécanicien mobile, pneus hiver Montréal, service pneus à domicile, Laval, Rive-Nord, Rive-Sud',
}
      ...
      <div className="container mx-auto px-4 py-3">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-8">
            <Link href="/" className="text-gray-300 hover:text-orange-500 transition-colors duration-300">
              Accueil
            </Link>
            <Link href="/services" className="text-gray-300 hover:text-orange-500 transition-colors duration-300">
              Services
            </Link>
            <Link href="/about" className="text-gray-300 hover:text-orange-500 transition-colors duration-300">
              À propos
            </Link>
            <Link href="/contact" className="text-gray-300 hover:text-orange-500 transition-colors duration-300">
              Contact
            </Link>
            <a 
              href="tel:5146497372" 
              className="bg-gradient-to-r from-orange-500 to-orange-600 text-white px-6 py-2 rounded-full hover:from-orange-600 hover:to-orange-700 transition-all duration-300 shadow-lg hover:shadow-orange-500/50 font-semibold"
            >
              📞 Appeler maintenant
            </a>
          </div>
    ...
    <footer className="bg-gray-900 border-t border-gray-800">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-400 text-sm">
              Service mobile de changement de pneus à domicile
            </p>
          </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400 text-sm">
          <p>© {new Date().getFullYear()} Mecano Express. Tous droits réservés.</p>
        </div>
      </div>
    </footer>
  )

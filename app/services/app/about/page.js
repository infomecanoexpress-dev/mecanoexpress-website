          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
            ...
            <div>
              ...
              <div className="space-y-4 text-gray-300 text-lg">
                ...
                <p>
                  Notre service mobile vous permet de faire changer vos pneus directement chez vous, à votre travail, ou n'importe où à Montréal et ses environs. Nous apportons tout l'équipement professionnel nécessaire pour un service de qualité supérieure.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <p className="text-gray-300">
                  Nous sommes toujours à l'heure et respectons nos engagements. Votre satisfaction est notre priorité.
                </p>
              </div>
              <div className="text-center">
                <div className="text-6xl mb-4">⚡</div>
                ...
                <p className="text-gray-300">
                  Service express sans compromis sur la qualité. Nous valorisons votre temps autant que le nôtre.
                </p>
              </div>
              <div className="text-center">
                <div className="text-6xl mb-4">🏆</div>
                ...
                <p className="text-gray-300">
                  Équipement moderne et techniques professionnelles pour un service impeccable, chars de luxe ou réguliers.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
            <div>
              ...
              <p className="text-gray-300 text-lg mb-6">
                Nous couvrons toute l'île de Montréal, Laval, la Rive-Nord et la Rive-Sud.
              </p>
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">Westmount, Outremont, Verdun, Rosemont et tous les arrondissements</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <span className="text-orange-500 text-2xl mr-4">📍</span>
                  <div>
                    ...
                    <p className="text-gray-400">Chomedey, Fabreville, Vimont, Sainte-Rose et tous les secteurs</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <span className="text-orange-500 text-2xl mr-4">📍</span>
            ...
            <div>
              <div className="relative h-96 rounded-2xl overflow-hidden">
                <Image
                  src="https://images.pexels.com/photos/8985923/pexels-photo-8985923.jpeg"
                  alt="Modern garage"
                  fill
                  className="object-cover"
                  unoptimized
          ...
          <div className="bg-gradient-to-r from-orange-500/20 to-orange-600/20 border-2 border-orange-500 rounded-2xl p-12 text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
              <div>
                ...
                <a href="tel:5146497372" className="text-white text-2xl hover:text-orange-300 transition-colors">
                  514 649-7372
                </a>
              </div>
              <div>
                ...
                <a href="mailto:info.mecanoexpress@gmail.com" className="text-white text-xl hover:text-orange-300 transition-colors">
              ...
              <div>
                ...
                <p className="text-white text-xl">Montréal & environs</p>
              </div>
            </div>
            <Link 
              href="/contact" 
              className="inline-block bg-gradient-to-r from-orange-500 to-orange-600 text-white px-8 py-4 rounded-full text-lg font-semibold hover:from-orange-600 hover:to-orange-700 transition-all duration-300"
            >
              Prendre rendez-vous
            </Link>
          </div>
